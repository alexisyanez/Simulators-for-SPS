...
parser.add_argument('--r', type=int, default=2000) #6000 #10000) ##original 300000) # este parametro corresponde al tiempo que se desa correr las simulaciones debe ser menor que time_period_all
...
parser.add_argument('--no-cl', dest='cl', action='store_false')
...
def main(time_period,target_distance,start_sampling_time,interval,RC_low,RC_high,RSRP_ratio_beacon,mu,obs,ds,nr,aw,sd,cl,mincl,maxcl,msdcl,mdcl):
    ...
    for section_index in range(0,int(time_period_all/10000)): #200)): # Oiriginal 10000
        if ds_index == 2:
            ...
            location_file_name = 'traffic_data_ped_v0/type_v0sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index) 
        elif ds_index == 1:            
            location_file_name = 'traffic_data_ped_v1/type_v1sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index) 
        elif ds_index == 10:            
            location_file_name = 'traffic_data_ped_v10/type_v10sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index)
        elif ds_index == 11:            
            location_file_name = 'traffic_data_ped_v11/type_v11sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index)
        elif ds_index == 12:            
            ...
            location_file_name = 'traffic_data_ped_v15/Cl_type_v15sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index)
        elif ds_index == 16:            
            location_file_name = 'traffic_data_ped_v16/Cl_type_v16sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index)
        elif ds_index == 17:           
            location_file_name = 'traffic_data_ped_v17/Cl_type_v17sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index)
        elif ds_index == 18:            
            location_file_name = 'traffic_data_ped_v18/Cl_type_v18sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index)
        elif ds_index == 19:            
            location_file_name = 'traffic_data_ped_v19/Cl_type_v19sumo_ped_vehicle_location_sec_' + str(section_index) # From pedestrian manhatan scenario + str(section_index)
   ...
   #print(ObserveVehicles[1])
    ...
    # =============================================================================
    eval_time = aw/sd    
    for t in range(0,time_period): # each steps means 1 ms in the current scenarios
        ...
        if t>start_sampling_time and t%eval_time==0:
            ...
            for vehicle in vehicle_list:
                ...
                total_sum_tran += sum_tran
                total_sum_rec += sum_rec                           
    ...
    if len(pdr_ratio_list) > 0:
        ...
        #serialized_pdr_ratio_list[1] = float(np.nanmean(ALL_pdr_ratio_list_individual[0]))
    else:
        avg_Total_pdr = 0
        std_Total_pdr = 0
