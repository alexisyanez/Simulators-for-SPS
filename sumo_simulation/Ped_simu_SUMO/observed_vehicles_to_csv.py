...
for j in range(0,5):
    ...
    for s in range(1+10000*j,10001+10000*j): #range(1+200*j,201+200*j): # range(1,6001):
        ...
        step_number= 370000+s #305000+s #315000+s #360000+s #330000+s #5000+s
        #print(str(step_number))
        location_step=pd.read_csv("Data_ped/v1location_for_timestep%s.csv"%str(step_number),header=None)
...
# =============================================================================
    filename = '/home/ayanez/Simulators-for-SPS/sumo_simulation/Ped_simu_SUMO/Data_ped/v1sumo_ped_vehicle_location_sec_'+str(j)
