...
for j in range(0,30):
    ...
    vehicle_data=[] 
    for s in range(1+1000*j,1001+1000*j): #range(1+200*j,201+200*j): # range(1,6001):
         
        step_number= 33000+s #5000+s
        ...
        if s==(1+1000*j):    # 200*j):  # list all vehicle IDs at first time-step
            ...
            for g in set_of_staying_nodes:
                #print(g)
                if g not in list(vehicle_data[s-(1+1000*j)][0]): # 200*j)][0]):
...
# =============================================================================
    observe_vehicles=[]
    for s in range(0,1000):#200): #0+j*200,200+j*200):
...
# =============================================================================
    filename='v4sumo_ped_vehicle_location_sec_'+str(j)
    n=0
